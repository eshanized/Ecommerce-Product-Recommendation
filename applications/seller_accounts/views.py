...
from applications.seller_accounts.models import *
from django.contrib import messages
...
from applications.seller_accounts.product_cat_ML import get_product_cat 
...
def signup(request):
    ...
    if request.method == 'POST':
        ...
        return redirect("applications.seller_accounts:company_details")
    ...
    if request.method == 'POST':
        ...
        if user is not None:
            if user.is_staff:
                ...
                return redirect("applications.seller_accounts:profile")            
        else:
            messages.warning(request,'Username and Password mismatch.')
            return redirect("applications.seller_accounts:signin")
...
def signout(request):
    ...
    return redirect("applications.main:index")
...
def company_details(request):
    if check_is_seller(request):
        if request.method == 'POST':
            ...
            return redirect("applications.seller_accounts:address_info")
    else:
        messages.warning(request,'Login as Seller Account.')
        return redirect('applications.seller_accounts:signin')
...
def add_single_product(request):
    if check_is_seller(request):
        if request.method == 'POST':
            ...
            return redirect('applications.seller_accounts:companyproducts')
    else:
        messages.warning(request,'Login as Seller Account.')
        return redirect('applications.seller_accounts:signin')
    return render(request, "dashboard-add-new-product.html")
...
def companyinfo(request):
    if check_is_seller(request):
        ...
        if request.method == 'POST':
            ...
            return redirect("applications.seller_accounts:companyinfo")
    else:
        return redirect('applications.seller_accounts:signin')
...
def companyproducts(request):
    if check_is_seller(request):
        ...
        if request.method == 'POST':
            product_name = request.POST.get("product_name")
            return redirect('applications.seller_accounts:search_company_product',product_name)
